...
class TestLoggingIn:
    ...
    def test_can_log_in_returns_200(self, user: UserFactory, testapp: TestApp) -> None:
        """Login successful."""
        # Goes to homepage
        res = testapp.get("/")
        ...
        form["password"] = "myprecious"  # noqa: S105
        # Submits
...
class TestRegistering:
    ...
    def test_can_register(self, user: UserFactory, testapp: TestApp) -> None:
        """Register a new user."""
        ...
        form["password"] = "secret"  # noqa: S105
        form["confirm"] = "secret"
        # Submits
        res = form.submit().follow()
        assert res.status_code == status.HTTP_200_OK
